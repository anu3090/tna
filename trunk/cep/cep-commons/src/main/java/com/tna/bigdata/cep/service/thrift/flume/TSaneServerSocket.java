...
public class TSaneServerSocket extends TServerTransport {
  ...
  /**
   * Creates just a port listening com.tna.cep.service.thrift.flume.server socket
   */
  ...
  private void bind() throws TTransportException {
    try {
      // Make com.tna.cep.service.thrift.flume.server socket
      serverSocket_ = new ServerSocket();
      // Prevent 2MSL delay problem on com.tna.cep.service.thrift.flume.server restarts
  ...
  public void close() {
    if (serverSocket_ != null) {
      try {
        ...
        LOGGER.warn("Could not close com.tna.cep.service.thrift.flume.server socket.", iox);
      }
      serverSocket_ = null;
    }
  }
