...
package com.cloudine.bigdata.cep.service.thrift.flume;
 ...
 * com.cloudine.bigdata.cep.service.thrift.flume.server socket api call is made.
 */
public class TSaneServerSocket extends TServerTransport {
  ...
  /**
   * Creates just a port listening com.cloudine.bigdata.cep.service.thrift.flume.server socket
   */
  ...
  private void bind() throws TTransportException {
    try {
      // Make com.cloudine.bigdata.cep.service.thrift.flume.server socket
      serverSocket_ = new ServerSocket();
      // Prevent 2MSL delay problem on com.cloudine.bigdata.cep.service.thrift.flume.server restarts
  ...
  protected TTransport acceptImpl() throws TTransportException {
    if (serverSocket_ == null) {
      throw new TTransportException(TTransportException.NOT_OPEN,
          "No underlying com.cloudine.bigdata.cep.service.thrift.flume.server socket.");
    }
    try {
  ...
  public void close() {
    if (serverSocket_ != null) {
      try {
        ...
        LOGGER.warn("Could not close com.cloudine.bigdata.cep.service.thrift.flume.server socket.", iox);
      }
      serverSocket_ = null;
    }
  }
