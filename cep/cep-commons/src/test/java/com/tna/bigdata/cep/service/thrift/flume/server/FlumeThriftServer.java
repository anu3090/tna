...
import com.tna.cep.service.thrift.flume.TSaneServerSocket;
import com.tna.cep.service.thrift.flume.TSaneThreadPoolServer;
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            logger.info(String.format(
                    "Starting blocking thread pool com.tna.cep.service.thrift.flume.server on port %d...", port));

            server.start();

        } catch (TTransportException e) {
            throw new IOException("Failed to create event com.tna.cep.service.thrift.flume.server " + e.getMessage(), e);
        }
